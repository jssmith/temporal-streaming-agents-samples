...
import openai
from analytics_shared.database import load_schema
from analytics_shared.sql_tool import execute_sql
from analytics_shared.sql_tool import TOOL_DEFINITION
...
async def run_turn(
    ...
    while True:
        ...
        async with client.responses.stream(**kwargs) as stream:
            async for event in stream:
                ...
                if event_type == "response.output_text.delta":
                    ...
                    if on_sentence and len(text_buffer) >= MIN_FLUSH_LEN:
        ...
        for item_id, tc in pending_tool_calls.items():
            ...
            result = await execute_sql(arguments.get("query", ""))
